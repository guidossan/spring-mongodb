...
public class Instantiation implements CommandLineRunner{
    ...
    public void run(String... args) throws Exception {
        ...
        Post post1 = new Post(null, "Partiu viagem", sdf.parse("21/03/2034"), "Vou viajar para São Paulo. Abraços!", alex);
        Post post2 = new Post(null, "Bom dia", sdf.parse("15/08/2018"), "Acordei feliz hoje!", alex);
